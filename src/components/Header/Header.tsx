            ...
            {navItems.map((item) => (
              <div key={item.name} className="relative">
                {item.hasDropdown ? (
                  ...
                  <a
                    href={item.href}
                    className="px-3 py-2 rounded-md text-sm font-medium text-blue-900 hover:text-orange-600 hover:bg-blue-50 transition-colors duration-200 whitespace-nowrap"
                  >
                    {item.name}
                  </a>
                )}
