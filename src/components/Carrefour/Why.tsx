              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`px-8 py-3 rounded-full transition-all flex items-center ${
                      activeTab === tab.id
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-orange-50 to-blue-50 p-8 rounded-3xl">
                  <div className="w-full h-64 bg-gradient-to-br from-slate-200 to-slate-300 rounded-2xl flex items-center justify-center">
                    {activeTab === "companies" ? (
